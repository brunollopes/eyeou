export const en = {
  ...
  rulesTitle1: 'Contest',
  rulesP1: 'At any moment will be running on EYEOU website 6 contests, 1 of them is a FREE contest the others 5 are entry paid contests. Free contest only allows upload of 1 photo per email address, while paid contest allows up to 10 photos.',
  rulesP2: 'Each contest will be have 3 phases:',
  rulesS1: 'OPEN ',
  rulesLi1: 'for submission, when the user can upload up to 10 photos during the left time, before ending this phase.',
  rulesS2: 'REVIEW ',
  rulesLi2: 'by judge painel, after the OPEN phase the contest will transit to the REVIEW phase where the designed judge (a minimum of 3 of our ambassadors) will be deciding who are the winners.',
  rulesS3: 'CLOSED ',
  rulesLi3: 'as soon as the judge makes the final decision the results will be sent for all the participants and the contests will be CLOSED.',

  rulesTitle2: 'TIME (opendays, reviewdays)',
  rulesP3: 'The time duration of the OPEN phase of each contest can be one of the following values, followed by the REVIEW time duration:',
  rulesTh1: 'Open phase duration',
  rulesTh2: 'Review phase duration',
  rulesTd1: '1 Week ( 7 days, 168 hours)',
  rulesTd2: '3 days ( 72 hours)',
  rulesTd3: ' Month ( 30 days, 720 hours)',
  ...
  rulesTitle3: 'AWARDS (prize, fee)',
  rulesP4: 'The prize money given is set to the following values and for each a correspondent entry fee as to be paid:',
  rulesTh3: 'Prize Money',
  rulesTh4: 'Entery Fee',
  rulesTd11: '2500€',
  rulesTd12: '5/15/25€',
  rulesTd13: '5000€',
  ...
  rulesTd20: '50/70/90€',
  rulesTd21: '100000€',
  rulesTd22: '80/120/150€',
  rulesP5: 'There is a minimum acceptable number of entries by (users / email addresses) required (with few exceptions) to start the contest. If at the end of the submission date, this number is not reached the contest will be cancelled or extended few more days, all users will be notified at the right moment. If the contest is cancelled all the users will receive back the paid fee.',
  rulesP6: 'There is a minimum acceptable number of entries (users, or email addresses) required (with few exceptions) to start the contest. If at the end of the submission date, this number is not reached the contest will be cancelled or extends few more days. If the contest is cancelled all the users will receive back the paid fee.',
  rulesP7: 'We can still continue with the contest even if the minimum number of acceptable entries is not reached, that decision will be decided by EYEOU directors.',
  rulesTh5: 'Prize Money',
  rulesTh6: 'Fee (enteries)',
  rulesTd23: '2500€',
  rulesTd24: '5 (500)/15(350)/25(100)€',
  rulesTd25: '5000€',
  rulesTd26: '10(500)/20(250)/30(200)€',
  rulesTd27: '20000€',
  rulesTd28: '25(800)/35(600)/45(500)€',
  rulesTd29: '30000€',
  rulesTd30: '35(900)/45(700)/55(600)€',
  rulesTd31: '50000€',
  rulesTd32: '50(1000)/70(1400)/90(800)€',
  rulesTd33: '100000€',
  rulesTd34: '80(1250)/120(900)/150(700)€',
  rulesP8: 'Looking to the second line, we can have a 2500€ contest with an entry fee of 5€ or 15€ or 25€. The value of the entry fee will be linked to the time set for the contest as show in the previous table.',

  rulesTitle4: 'Types',
  rulesP9: 'An FREE contest is a contest where each user can upload up to 1 photos for free, we will use, only the email address of the user to unique identify its uniqueess.',
  rulesP10: 'A PAID contest is same as a FREE contest but the user will have to pay the indicated fee for that contest before be able to upload any image and can upload up to 10 photos.',

  rulesTitle5: 'WINNERS',
  rulesP11: 'The winners will be decided by our selected judge painel for that contest. Our judges are a team of our ambassadors, well know and their profile and contacts can are available on the website. All of them are certified professional photographers.',
  rulesP12: 'EYEOU judges will judge the photos based on the following criteria: technic, quality, originality and creativity in accordance with the contest’s theme.',
  rulesP13P1: 'When the contest is finished all the submitted photos will have a score, the sum of the score from',
  rulesP13S1: ' technique,',
  rulesP13S2: ' quality,',
  rulesP13S3: ' originality,',
  rulesP13SP1: ' and ',
  rulesP13S4: 'creativity ',
  rulesP13P2: 'divided by 4 followed by the sum of the each judge score divided by the number of judges. The photos with the 3 higher scores will be the winners.',
  rulesP14: 'Each criteria will be rated from 0 to 10 where 10 is the best of that criteria and 0 the worst.',

  rulesTitle6: 'Prize money limits',
  rulesP15: 'The prize money delivered to the winners will be based on the photo final score and the following scale:',
  rulesLi4: 'Scores below 2.00, no prize money will be given.',
  rulesLi5: 'Scores from  2.01 to 3.00, maximum of prize money granted is set to 500€',
  rulesLi6: 'Scores from  3.01 to 5.00, maximum of prize money granted is set to 2500€',
  rulesLi7: 'Scores from  5.01 to 7.00, maximum of prize money granted is set to 5000€',
  rulesLi8: 'Scores  over 7.01, maximum of prize money granted is set to the available cash for prize of the contest',
  rulesP16: 'For instance, on a contest with 3 judges, a photo will be scored like that:',
  rulesLi9: 'Judge 1: technic: 7 quality: 6 originality: 8 creativity: 5 > Final judge score is 6.50',
  rulesLi10: 'Judge 2: technic: 5 quality: 4 originality: 5 creativity: 6 > Final judge score is 5.00',
  rulesLi11: 'Judge 3: technic: 8 quality: 6 originality: 7 creativity: 4 > Final judge score is 6.25',
  rulesP17: 'Final score will be set to 5.92 (we take always the integer part of the division and the following 2 decimals)',
  rulesP18: 'In case of tie, the photo that was submitted first, will be the winner.',
  rulesP19: 'The winners prize will be as follow (if score allows it or the maximum amount for the given score, as above)',

  rulesTitle7: 'Payout Structure (top 20% paid)',
...
export const pt = {
  ...
  pay: 'PAGAR',
  next: 'PRÓXIMO',
  howitWorksList1: 'Escolhe um dos concursos listados (pagos ou grátis)',
  howitWorksList2: 'Pague a taxa de entrada (min. 2€) nos concursos pagos',
